  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Build Your Legacy</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Build Your Legacy</h2>
        <p className="section-sub">Shape your dynasty across generations and leave a lasting mark on history.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/chronicles_historical_adventure.png" alt="Build Your Legacy" />
