...
export default function ChroniclesPets() {
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Pets</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Pets</h2>
        <p className="section-sub">Adopt, train, and bond with animal companions across the ages.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/chronicles_historical_adventure.png" alt="Pets" />
