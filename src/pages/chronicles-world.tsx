  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>World Explorer</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">World Explorer</h2>
        <p className="section-sub">Navigate zones, perform activities, and earn rewards across eras.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/chronicles_historical_adventure.png" alt="World Explorer" />
