  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Scenario Generator</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Scenario Generator</h2>
        <p className="section-sub">Create and test custom historical scenarios with AI.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/ancient_lore_library.png" alt="Scenario Generator" />
