  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Team</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Team</h2>
        <p className="section-sub">The people behind Chronicles — developers, designers, and storytellers.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/emotional_warrior_portrait.png" alt="Team" />
