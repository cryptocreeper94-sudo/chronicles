  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Gameplay</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Gameplay</h2>
        <p className="section-sub">How Chronicles works — mechanics, AI narratives, and decision-making.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/wild_west_frontier_town.png" alt="Gameplay" />
