      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-black/80 backdrop-blur-xl">
        <div className="container mx-auto px-4 h-14 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 shrink-0" data-testid="link-chrono-home">
            ...
            <span className="font-display font-bold text-lg tracking-tight hidden sm:inline bg-gradient-to-r from-cyan-400 to-sky-400 bg-clip-text text-transparent">
              Chronicles
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="border-sky-500/50 text-sky-400 bg-sky-500/10 text-[10px] whitespace-nowrap animate-pulse hidden sm:flex">
              <Sparkles className="w-3 h-3 mr-1" /> Coming 2026
            </Badge>
            
            <Link href="/crowdfund">
              <Button size="sm" className="h-8 text-xs gap-1 bg-gradient-to-r from-sky-600 to-pink-600 hover:from-sky-500 hover:to-pink-500 hidden sm:flex" data-testid="nav-cta-support">
          ...
          >
            <div className="p-4">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-2">
                  <Shield className="w-7 h-7 text-cyan-400" />
                  <span className="font-display font-bold text-xl bg-gradient-to-r from-cyan-400 to-sky-400 bg-clip-text text-transparent">
                    Chronicles
                  </span>
                </div>
                <button 
              ...
              >
                <Link href="/crowdfund" onClick={() => setMobileMenuOpen(false)}>
                  <Button size="lg" className="w-full rounded-xl gap-2 bg-gradient-to-r from-sky-600 to-pink-600" data-testid="mobile-cta-support">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-2 text-xs text-white/40">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 px-2 py-1 rounded bg-sky-500/20 border border-sky-500/30 text-sky-400 hover:text-sky-300 hover:bg-sky-500/30 transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://darkwavestudios.io" target="_blank" rel="noopener noreferrer" className="text-sm text-white/60 hover:text-sky-400 transition-colors flex items-center gap-1" data-testid="footer-link-studios">
...
function StickyJoinBar() {
  ...
  return (
    <motion.div
      initial={{ y: 100 }}
      animate={{ y: 0 }}
      className="fixed bottom-0 left-0 right-0 z-40 bg-gradient-to-r from-sky-900/95 via-black/95 to-cyan-900/95 backdrop-blur-xl border-t border-white/10 p-3 sm:p-4"
    >
      <div className="container mx-auto max-w-6xl flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Link href="/community" className="flex-1 sm:flex-none">
            <Button size="sm" className="w-full sm:w-auto gap-2 bg-gradient-to-r from-cyan-500 to-sky-500 hover:from-cyan-400 hover:to-sky-400 text-sm" data-testid="sticky-join-waitlist">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={primaryAction.href}>
              <Button size="lg" className="rounded-full gap-2 text-lg px-8 py-6 bg-gradient-to-r from-cyan-500 via-sky-500 to-pink-500 hover:from-cyan-400 hover:via-sky-400 hover:to-pink-400 shadow-xl" data-testid="cta-primary">
    ...
    <span className="relative inline-flex items-center">
      ...
      <AnimatePresence>
        {showTooltip && (
          ...
          >
            <p className="text-xs font-bold text-sky-400 mb-1">{term}</p>
