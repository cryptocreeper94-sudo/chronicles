...
const FEATURED_ERAS = [
  ...
  { id: "medieval", name: "Age of Crowns", period: "1200 CE", image: historicalKingdom, color: "from-sky-500 to-cyan-600" },
...
const SOCIAL_STATS = [
  { label: "Eras Available", value: "10", icon: <Globe className="w-4 h-4 text-sky-400" /> },
  ...
  return (
    <ChronoLayout currentPage="/">
      <VideoHero posterSrc={historicalWorld}>
        ...
        >
          <Badge className="mb-6 px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-sky-500/20 border-cyan-500/30 text-white text-sm backdrop-blur-sm">
          ...
          >
            <p className="text-2xl md:text-4xl font-bold text-white mb-2">
              <span className="bg-gradient-to-r from-cyan-400 to-sky-400 bg-clip-text text-transparent">YOU.</span> The Legend.
            </p>
          ...
          >
            <Link href="/chronicles">
              <Button size="lg" className="rounded-full gap-2 text-lg px-8 py-6 bg-gradient-to-r from-cyan-500 via-sky-500 to-pink-500 hover:from-cyan-400 hover:via-sky-400 hover:to-pink-400 text-white shadow-xl shadow-sky-500/25 hover:shadow-sky-500/40 transition-all" data-testid="hero-explore">
      ...
      <section className="py-24 px-4 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-black via-sky-950/10 to-black pointer-events-none" />
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-transparent via-cyan-950/10 to-transparent">
        <div className="container mx-auto max-w-7xl">
          ...
          >
            <Link href="/eras">
              <Button className="rounded-full gap-2 bg-gradient-to-r from-cyan-600 to-sky-600 hover:from-cyan-500 hover:to-sky-500" data-testid="explore-all-eras">
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-transparent via-pink-950/10 to-transparent">
        <div className="container mx-auto max-w-7xl">
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-pink-500/10 via-sky-500/10 to-cyan-500/10 border border-white/10">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              const colorClasses = {
                ...
                purple: { bg: "from-sky-500 to-pink-600", border: "border-sky-500/30", text: "text-sky-400" },
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-500/10 to-transparent border border-pink-500/20">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-pink-500 to-sky-600 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <Link href="/community">
                      <Button size="sm" className="rounded-full gap-2 bg-gradient-to-r from-pink-600 to-sky-600" data-testid="join-socials">
