  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Creators</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Creators</h2>
        <p className="section-sub">Meet the content creators and community builders shaping Chronicles.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/renaissance_florence_italy_scene.png" alt="Creators" />
