  ...
  return (
    <div className="chrono-layout">
      <nav className="chrono-nav">
        ...
        <div className="chrono-nav-brand">⚡ <span>Travel</span></div>
        <div />
      </nav>
      <main className="chrono-main">
        <h2 className="section-title">Travel</h2>
        <p className="section-sub">Journey between regions, discover landmarks, and unlock new territories.</p>
        <div className="glass-card glow" style={{ textAlign: 'center' }}>
          <div className="card-image" style={{ borderRadius: '12px 12px 0 0' }}>
            <img src="/images/wild_west_frontier_town.png" alt="Travel" />
